...
?>
<form action="?page=editar-act" method="POST">
    ...
    <br>
    <input type="date" name="dt_nascimento" value="<?= $clientes['dt_nascimento']; ?>">
    <br><br>
    <label>Sexo: </label>
    <div class="form-check">
        <input class="form-check-input" <?php $sexo = filter_input(INPUT_POST, 'sexo'); if ($sexo == 'm'){ echo "MASCULINO";?>
    ...
    <div class="form-floating">
        <textarea class="form-control" placeholder="Deixe um comentário" name="observacao" value="<?= $clientes['observacao']; ?>" style="height: 100px"></textarea>
        <label for="floatingTextarea2">Observações</label>
    </div>
    <br>
    <label>Selecione seu estado: </label><br>
    <select class="form-select" aria-label="Default select example" 
                    name="uf" id="uf" value="<?= $clientes['uf']; ?>">
